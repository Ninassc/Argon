...
class CompartilhamentosRecebidosTab extends StatefulWidget {
  ...
  @override
  State<CompartilhamentosRecebidosTab> createState() =>
      _CompartilhamentosRecebidosTabState();
}
...
class _CompartilhamentosRecebidosTabState
  ...
  Widget build(BuildContext context) {
    ...
    if (compartilhamentos.isEmpty) {
      return const Center(
        child: Text("Nenhum processo foi compartilhado com você."),
      );
    }
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Column(
          ...
          children: [
            Text(
              "Compartilhado por ${compartilhamento.usuarioOrigem.nome}",
